...
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, poolAddressScript, extraNoncePlaceholder, reward, txMessages, recipients, network){
    ...
    this.getJobParams = function(){
        if (!this.jobParams){
            ...
            if (this.coinName === 'VIPSTARCOIN') {
                this.jobParams.push(util.packInt32LE(this.rpcData.version).toString('hex'));
                this.jobParams.push(util.packUInt32LE(this.rpcData.curtime).toString('hex'));
                this.jobParams.push(this.hashStateRootReversed);
                this.jobParams.push(this.hashUTXORootReversed);
            }
            if not (this.coinName === 'VIPSTARCOIN') {
                this.jobParams.push(util.packInt32BE(this.rpcData.version).toString('hex'));
                this.jobParams.push(util.packUInt32BE(this.rpcData.curtime).toString('hex'));
            }
